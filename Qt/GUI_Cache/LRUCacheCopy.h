...
//Этот файл с немного искаженной логикой только для 
...
public:
    ...
    MyNamespace::ReturnValue<Value> Get(Key const & key)
    {
        ...
        return MyNamespace::ReturnValue<Value>(0, getNewValue.GetValue()); //два вызова конструктора
    }
};
